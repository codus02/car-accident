...
#######################
# 데이터 불러오기
df = pd.read_csv("C:/Users/chaet/Downloads/음주운전교통사고비율_시도_시_군_구__20241204193205.csv", encoding='UTF-8')
df2 = pd.read_csv("C:/Users/chaet/Downloads/1인당_자동차_등록대수_시도_시_군_구__20241216182607.csv", encoding='UTF-8')
korea_geojson = json.load(open("C:/Users/chaet/Downloads/SIDO_MAP_2022_geoJSON.json", encoding="UTF-8"))
